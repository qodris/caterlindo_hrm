...
-- Records of tb_admin
-- ----------------------------
INSERT INTO `tb_admin` VALUES ('ADM130716000001', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Adminstrator', 'Server', '0', '-', 'admin@email.com', '0');
...
-- Records of tb_hotel
-- ----------------------------
INSERT INTO `tb_hotel` VALUES ('HTL140816000001', 'PRO040816000001', 'KOT040816000001', 'Hotel Bagus', 'Jln. Bagus sudah bagus', '0', 'Hotel ini, didirikan pada bla bla bla...');
...
INSERT INTO `tb_img` VALUES ('IMG140816000001', 'HTL140816000001', '9137Florida-Hotel-Orlando-Night.jpg');
...
CREATE TABLE `tb_kamar` (
  `id_kamar` varchar(15) COLLATE latin1_general_ci NOT NULL DEFAULT '',
...
-- Records of tb_kota
-- ----------------------------
INSERT INTO `tb_kota` VALUES ('KOT040816000001', 'PRO040816000001', 'Kediri');
...
-- ----------------------------
INSERT INTO `tb_provinsi` VALUES ('PRO040816000001', 'Jawa Timur');
...
CREATE TABLE `td_reservasi` (
  ...
  `id_kamar` varchar(15) COLLATE latin1_general_ci DEFAULT NULL,
