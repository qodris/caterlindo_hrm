...
if(!empty($Detail)){
	...
	<div class="content-panel">
		<div class="panel-heading">
			<h3><i class="fa fa-angle-right"></i> Edit Data <small>Form Edit <?php echo $judul; ?></small></h3>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="form-panel">
				...
				<div class="x_title">
					<h2>Form Edit <small>Data <?php echo $judul; ?></small></h2>
				</div>
				<div class="x_content">
					<br />
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<input type="text" id="kategori" placeholder="Kategori Pekerjaan" name="kategori" class="form-control col-md-7 col-xs-12" required="required" value="<?php echo $Detail['nm_kat_pekerjaan']; ?>">
							</div>
						</div>
